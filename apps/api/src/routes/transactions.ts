    ...
    async ({ body, set }) => {
      try {
        ...
        const newTransaction = {
          ...
          notes: body.notes ?? '',
          importedSource: body.importedSource ?? '',
          createdBy: 'human',
  ...
  .put(
    ...
    async ({ params, body, set }) => {
      ...
      try {
        ...
        // Update transaction
        const currentTransaction = mockTransactions[transactionIndex]!;
        mockTransactions[transactionIndex] = {
          id: currentTransaction.id,
          accountId: currentTransaction.accountId,
          date: body.date || currentTransaction.date,
          amount: body.amount !== undefined ? body.amount : currentTransaction.amount,
          merchant: body.merchant || currentTransaction.merchant,
          category: body.category || currentTransaction.category,
          notes: body.notes !== undefined ? body.notes : currentTransaction.notes,
          importedSource: currentTransaction.importedSource,
